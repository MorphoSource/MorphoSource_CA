...
# ----------------------------------------
	...
	*/
	...
	function caMakeSearchResult($ps_table, $pa_ids, $pa_options=null) {
		$o_dm = Datamodel::load();
		if ($t_instance = $o_dm->getInstanceByTableName('ms_projects', true)) {	// get an instance of a model inherits from BundlableLabelableBaseModelWithAttributes; doesn't matter which one
