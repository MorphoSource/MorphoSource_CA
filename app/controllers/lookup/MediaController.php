 ...
 */
 	...
 	class MediaController extends BaseLookupController {
 		# -------------------------------------------------------
 		protected $opb_uses_hierarchy_browser = false;
 		protected $ops_table_name = 'ms_media';		// name of "subject" table (what we're editing)
 		protected $ops_name_singular = 'media';
 		protected $ops_search_class = 'MediaSearch';
 		# -------------------------------------------------------
 	}
 ?>