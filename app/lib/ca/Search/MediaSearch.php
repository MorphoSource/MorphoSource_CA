<?php
/** ---------------------------------------------------------------------
 * app/lib/ca/Search/MediaSearch.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
include_once(__CA_LIB_DIR__."/ca/Search/MediaSearchResult.php");

class MediaSearch extends BaseSearch {
	# ----------------------------------------------------------------------
	/**
	...
	public function &search($ps_search, $pa_options=null) {
		return parent::doSearch($ps_search, new MediaSearchResult(), $pa_options);
	}
	# ----------------------------------------------------------------------
}
?>