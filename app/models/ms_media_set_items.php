<?php
/** ---------------------------------------------------------------------
 * app/models/ms_media_set_items.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_media_set_items'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'set_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Set id', 'DESCRIPTION' => 'set item belongs to'
		),
		'created_on' => array(
...
class ms_media_set_items extends BaseModel {
	# ---------------------------------
	...
	protected $TABLE = 'ms_media_set_items';
