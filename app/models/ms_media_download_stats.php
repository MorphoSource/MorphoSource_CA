<?php
/** ---------------------------------------------------------------------
 * app/models/ms_media_download_stats.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_media_download_stats'] = array(
 	'NAME_SINGULAR' 	=> _t('media download stat'),
 	'NAME_PLURAL' 		=> _t('media download stats'),
 	'FIELDS' 			=> array(
 		'download_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Download id'), 'DESCRIPTION' => _t('Unique numeric identifier used to identify this download stat')
		),
		'media_id' => array(
				'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_HIDDEN,
...
class ms_media_download_stats extends BaseModel {
	# ---------------------------------
	...
	protected $TABLE = 'ms_media_download_stats';
	...
	protected $LIST_FIELDS = array('download_id');
	...
	protected $ORDER_BY = array('downloaded_on');
