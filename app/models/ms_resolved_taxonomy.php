<?php
/** ---------------------------------------------------------------------
 * app/models/ms_resolved_taxonomy.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_resolved_taxonomy'] = array(
 	'NAME_SINGULAR' 	=> _t('resolved taxon'),
 	'NAME_PLURAL' 		=> _t('resolved taxa'),
 	'FIELDS' 			=> array(
 		'taxon_id' => array(
		...
		'rank' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Rank'), 'DESCRIPTION' => _t('Taxon rank.'),
		...
		'name' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Taxon name'), 'DESCRIPTION' => _t('Name for taxon.'),
				'BOUNDS_LENGTH' => array(0,100)
		),
		'common_name' => array(
				'FIELD_TYPE' => FT_TEXT, 'DISPLAY_TYPE' => DT_FIELD, 
...
class ms_resolved_taxonomy extends BaseModel {
	# ---------------------------------
	...
	protected $TABLE = 'ms_resolved_taxonomy';
	...
	# Search
	# ------------------------------------------------------
	protected $SEARCH_CLASSNAME = 'ResolvedTaxonomySearch';
	protected $SEARCH_RESULT_CLASSNAME = 'ResolvedTaxonomySearchResult';
