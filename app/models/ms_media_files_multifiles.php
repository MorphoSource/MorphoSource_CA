<?php
/** ---------------------------------------------------------------------
 * app/models/ms_media_files_multifiles.php : table access class for table ms_media_files_multifiles
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_media_files_multifiles'] = array(
 	'NAME_SINGULAR' 	=> _t('media multifile'),
 	'NAME_PLURAL' 		=> _t('media multifiles'),
 	'FIELDS' 			=> array(
 		'multifile_id' => array(
		...
		'media_file_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Media id', 'DESCRIPTION' => 'The media to which this multifile is attached.'
		),
		'resource_path' => array(
		...
		'media' => array(
				...
				"MEDIA_PROCESSING_SETTING" => 'ms_media_files_multifiles',
...
class ms_media_files_multifiles extends BundlableLabelableBaseModelWithAttributes implements IBundleProvider {
	# ---------------------------------
	...
	protected $TABLE = 'ms_media_files_multifiles';
