...
BaseModel::$s_ca_models_definitions['ms_media_sets'] = array(
 	'NAME_SINGULAR' 	=> _t('media cart'),
 	'NAME_PLURAL' 		=> _t('media carts'),
 	'FIELDS' 			=> array(
 		'set_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Set id'), 'DESCRIPTION' => _t('Unique numeric identifier used to identify record')
		),
		'user_id' => array(
				'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_HIDDEN,
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'User id', 'DESCRIPTION' => 'User that made set'
		),
		'created_on' => array(
...
class ms_media_sets extends BaseModel {
	# ---------------------------------
	...
	protected $LIST_FIELDS = array('set_id');
