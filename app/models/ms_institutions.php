<?php
/** ---------------------------------------------------------------------
 * app/models/ms_institutions.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_institutions'] = array(
 	...
 	'FIELDS' 			=> array(
 		'institution_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Institution reference id'), 'DESCRIPTION' => _t('Unique numeric identifier used to identify this institution')
		),
		'name' => array(
...
class ms_institutions extends BaseModel {
	# ---------------------------------
	...
	protected $PRIMARY_KEY = 'institution_id';
