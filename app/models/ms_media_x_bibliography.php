<?php
/** ---------------------------------------------------------------------
 * app/models/ms_media_x_bibliography.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ms_media_x_bibliography'] = array(
 	...
 	'NAME_PLURAL' 		=> _t('bibliography media'),
 	'FIELDS' 			=> array(
 		'link_id' => array(
...
class ms_media_x_bibliography extends BaseModel {
	# ---------------------------------
	...
	protected $TABLE = 'ms_media_x_bibliography';
