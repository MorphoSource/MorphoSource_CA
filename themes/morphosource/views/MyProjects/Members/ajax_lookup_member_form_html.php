...
<?php
	print "<div class='formLabel'>Enter the email address of the individual you would like to invite to your project:<br/>";
	if($va_errors["member_email"]){
		print "<div class='formErrors'>".$va_errors["member_email"]."</div>";
	}
	print "<input type='text' name='member_email' size='90'>";
	print "</div>";
