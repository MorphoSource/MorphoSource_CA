				...
				<table>
					...
					<tr>
						<td>
							...
							<?php 
								print_r('{mode_1}');
								print $t_scanner_modes->htmlFormElement('modality', "<div class='formLabel'>^LABEL<br/>^ELEMENT</div>", array('name' => 'scanner_modality_{n}_1', 'value' => '')); ?>
						</td>
						<td>
							<div class="mode_invis" style='display:none;'>{mode_2}</div>
							<div class="name_invis" style='display:none;'>scanner_modality_{n}_2</div>
							<?php print_r('{mode_2}'); ?>
							<?php print str_replace("textarea", "textentry", $t_scanner_modes->htmlFormElement('modality', "<div class='formLabel'>^LABEL<br/>^ELEMENT</div>", array('name' => 'scanner_modality_{n}_2', 'value' => '{mode_2}'))); ?>
						</td>
						<td>
							<div class="mode_invis" style='display:none;'>{mode_3}</div>
							<div class="name_invis" style='display:none;'>scanner_modality_{n}_3</div>
							<?php print_r('{mode_3}'); ?>
							<?php print str_replace("textarea", "textentry", $t_scanner_modes->htmlFormElement('modality', "<div class='formLabel'>^LABEL<br/>^ELEMENT</div>", array('name' => 'scanner_modality_{n}_3', 'value' => '{mode_3}'))); ?>
						</td>
					</tr>
				</table>
			</div>
