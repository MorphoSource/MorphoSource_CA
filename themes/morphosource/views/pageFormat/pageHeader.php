...
<!-- /jfu changes -->    
<!--smctodo: 
    1) need to move js to javascript.conf, register in MediaController.php.  
 			JavascriptLoadManager::register("formrepeater");
    2) move css to?
-->
<!-- The Templates plugin is included to render the upload/download listings -->
<script src="/vendor/jquery-file-upload/js/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="/vendor/jquery-file-upload/js/load-image.all.min.js"></script>
...
<script src="/vendor/jquery-file-upload/js/main.js"></script>

    <!-- Bootstrap styles : smc: currently needed for display progress bar -->
...
<link rel="stylesheet" href="/vendor/jquery-file-upload/css/jquery.fileupload.css">
    ...
    <style>
        ...
        .fileinput-button:hover {
            cursor:pointer;
            background-color: #606f82; /* smctodo: move this morphosource.css later */
        }
        .fileinput-button.disabled:hover {
            cursor:default;
            background-color: transparent; /* smctodo: move this morphosource.css later */
        }
        .disabled {
            color:#aaa !important;
        ...
        .jr-btnAdd,
        .jr-btnRemove {
            /* smctodo: hide and move the button away later */
            float:right;
            /* visibility: hidden; */
            z-index: -999;
        }
        ...
        /*
        #formArea input[type="text"].jfu_media_file_name ,
        #formArea input.jfu_media_file_name {
