...
?>
		...
		<div style="margin-top: 20px; margin-bottom: 20px; border: 1px solid #003880; border-radius: 5px; width: 860px;">
			<div style="margin:15px">
				<span><b>January 26th Update:</b> MorphoSource 2.0 will launch Thursday, January 27! MorphoSource 2.0 includes many new features like web viewing of CT data, expanded support for 3D modalities like photogrammetry, and new support for cultural heritage objects. We brought the current site down for maintenance on Tuesday, January 12th. See you tomorrow!</span>
			</div>
		</div>
	</div><!-- end header -->
	<div id="pageArea">
